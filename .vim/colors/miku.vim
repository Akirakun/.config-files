" Vim color file
" Scriptname: miku 
" Author: Kyle Schaare <kschaare03@gmail.com> 
...
"
" Based on the vimbrant color scheme, which is based off of the
" molokai theme by Tomas Restrepo, which in turn
...
if exists("g:miku")
    let s:miku_original = g:miku_original
else
    let s:miku_original = 0
endif
